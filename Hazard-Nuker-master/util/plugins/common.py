...
def setTitle(_str):
    ...
    if system == 'nt':
        #if its windows
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | Made By KEMTA#0001")
    elif system == 'posix':
        #if its linux
        sys.stdout.write(f"\x1b]0;{_str} | Made By KEMTA#0001\x07")
    else:
...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = getTempDir()+"\\KEMTA_proxies"
    print(f"{Fore.YELLOW}Please wait while KEMTA Nuker Scrapes proxies for you!{Fore.RESET}")
    ...
    setTitle(f"KEMTA Nuker {THIS_VERSION}")
...
def getTheme():
    themes = ["KEMTA", "dark", "fire", "water", "neon"]
    with open(getTempDir()+"\\KEMTA_theme", 'r') as f:
        text = f.read()
...
def setTheme(new: str):
    with open(getTempDir()+"\\KEMTA_theme", 'w'): pass
    with open(getTempDir()+"\\KEMTA_theme", 'w') as f:
        f.write(new)
...
def banner(theme=None):
    if theme == "dark":
        ...
        print(f'''{Fore.GREEN}
                              ...
                              ██╔═██╗░██╔══╝░░██║╚██╔╝██║░░░██║░░░██╔══██║
MADE BY KEMTA#0001            ██║░╚██╗███████╗██║░╚═╝░██║░░░██║░░░██║░░██║
https://discord.gg/dfDP5DVjnb ╚═╝░░╚═╝╚══════╝╚═╝░░░░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝                                 '''.replace('█', f'{Fore.WHITE}█{Fore.GREEN}') + f'''   
...
def bannerTheme(type1, type2):
    return type1(f'''
                             ...
                             ██╔═██╗░██╔══╝░░██║╚██╔╝██║░░░██║░░░██╔══██║
MADE BY KEMTA#0001           ██║░╚██╗███████╗██║░╚═╝░██║░░░██║░░░██║░░██║
https://discord.gg/dfDP5DVjnb╚═╝░░╚═╝╚══════╝╚═╝░░░░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝''')+type2('''  
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
